parameters = [
  { name = "dev.frontend.catalogue_url", value = "http://catalogue-dev.devopswithbhanu.online:8080/", type = "String" },
  { name = "dev.frontend.user_url", value = "http://user-dev.devopswithbhanu.online:8080/", type = "String" },
  { name = "dev.frontend.cart_url", value = "http://cart-dev.devopswithbhanu.online:8080/", type = "String" },
  { name = "dev.frontend.shipping_url", value = "http://shipping-dev.devopswithbhanu.online:8080/", type = "String" },
  { name = "dev.frontend.payment_url", value = "http://payment-dev.devopswithbhanu.online:8080/", type = "String" },
  { name = "dev.user.mongo", value = "true", type = "String" },
  { name = "dev.user.redis_host", value = "redis-dev.devopswithbhanu.online", type = "String" },
  { name = "dev.user.mongo_url", value = "mongodb-dev.devopswithbhanu.online:27017/catalogue", type = "String" },
  ...
  { name = "dev.catalogue.mongo_url", value = "mongodb-dev.devopswithbhanu.online:27017/users", type = "String" },
